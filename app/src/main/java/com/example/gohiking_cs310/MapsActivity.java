...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng losAngeles = new LatLng(34.052235, -118.243683); // Coordinates for Los Angeles
        mMap.addMarker(new MarkerOptions().position(losAngeles).title("Marker in Los Angeles"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(losAngeles, 12)); // Set an appropriate zoom level
    }
}